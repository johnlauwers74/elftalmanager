...
export const generateExerciseSuggestions = async (topic: string) => {
  // Always create a new GoogleGenAI instance with the API_KEY from process.env
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        responseSchema: {
          ...
          required: ["title", "type", "ageGroup", "playersCount", "shortDescription", "detailedInstructions", "tags"]
        }
      }
    });
